var diagnostic = require('../controllers/diagnostic');
...
router.post('/check-profile', oauth.oauth.authorise(), upload.array(), function (req, res) {
    ...
    diagnostic.checkProfile(data, function (result) {
        res.send(result);
    })
})
...
router.post('/new-profile', oauth.oauth.authorise(), upload.array(), function (req, res) {
    ...
    diagnostic.metaDataForNewProfile(data, function (result) {
        res.send(result);
    })
})
    ...
    uploadFile(req, res, function (err) {
        ...
        if (err) {
            ...
            async.forEach(req.files, function (up_files, callback) {
                ...
                diagnostic.saveBasicDetails(data, function (result) {
                    res.send(result);
                })
            });
        }
